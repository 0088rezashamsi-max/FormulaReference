...
Installation & Usage
Create a new console project (optional):
...
bash dotnet run How to Use Run the program. At the main menu, type the name of a section: Physics, Mathematics, or Chemistry. Inside each section, choose:
...
Example text Enter the name of the desired section (or 'Exit' to quit): Physics ... Result: F = 10 × 9.8 = 98 Newtons Contributing Contributions are welcome. To add a new formula:
